...
*/
/*
    std::steady_clock::time_point t1 = chrono::steady_clock::now();//set time record
    std::steady_clock::time_point t2 = chrono::steady_clock::now();
    std::duration<double,std::milli> time_used = chrono::duration_cast<chrono::duration<double,std::milli>>(t2 - t1);
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    chrono::steady_clock::time_point t11 = chrono::steady_clock::now();//set time record
    chrono::steady_clock::time_point t22 = chrono::steady_clock::now();
    chrono::duration<double,std::milli> time_used = chrono::duration_cast<chrono::duration<double,std::milli>>(t22 - t11);
...
////////////////////////////////////////////////////////////////////////////////////
	...
	time_used = chrono::duration_cast<chrono::duration<double,std::milli>>(t22 - t11);
	cout << "cost time: " << time_used.count() << " ms." << endl;
