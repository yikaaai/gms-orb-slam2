...
// const Frame &CurrentFrame 輸入當前幀
// const vector<int> &vMatches12 當前幀與參考幀的匹配關係

// bool Initializer::Initialize(const Frame &ReferenceFrame, const Frame &CurrentFrame, const vector<int> &vMatches12, cv::Mat &R21, cv::Mat &t21, vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated)
...
// 4. 用兩個線程分別計算F與H矩陣
    ...
    // 構造線程
    // &Initializer::FindHomography 線程主函式
